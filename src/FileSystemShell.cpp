...
void runPreparedCommand(FileSystem* fs) {
    ...
    doCommand(fs, "import test.txt imported_file.txt");
    doCommand(fs, "cat imported_file.txt");
    doCommand(fs, "ls");
    doCommand(fs, "mm");
    std::cout << "----------------------------------------------------------------" << std::endl;
    std::cout << "----------------------------------------------------------------" << std::endl;
    ...
    doCommand(fs, "export imported_file.txt exported.txt");
    std::cout << "----------------------------------------------------------------" << std::endl;
    std::cout << "----------------------------------------------------------------" << std::endl;    
    // Show memory state
